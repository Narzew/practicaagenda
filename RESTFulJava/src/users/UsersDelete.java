...
/**
 * Jersey REST client generated for REST resource:UsersDeleteResource
 * [users/delete]<br>
 * USAGE:
 * <pre>
 *        UsersDelete client = new UsersDelete();
...
public class UsersDelete {
    ...
    public UsersDelete() {
        ...
        webTarget = client.target(BASE_URI).path("users/delete");
    }
